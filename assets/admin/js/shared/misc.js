      ...
      if (bannerState == "enabled") {
        ...
        $("body").prepend('\
          <div class= "item-purchase-banner">\
            <p class="banner-text">Web Yazılım / E-Ticaret / SEO Danışmanlığı Gibi Çözümler İçin Web Sitemiz Üzerinden Bizlere Ulaşabilirsiniz.</p>\
              <a href="https://bugrakara.com.tr" target="_blank" class= "banner-button btn btn-primary btn-icon">\
                <i class="mdi mdi-cart"></i> Bilgi Al\
              </a>\
