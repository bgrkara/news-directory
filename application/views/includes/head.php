...
<title><?php echo $yerelgazetedetay->sehir_title;?></title>
<meta name="description" content="<?php echo $yerelgazetedetay->sehir_description;?>">
<meta name="keywords" content="<?php echo $yerelgazetedetay->sehir_keywords;?>">
<link rel="canonical" href="<?php echo base_url("/yerel/").$yerelgazetedetay->sehir_url;?>" />
