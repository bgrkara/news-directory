        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10"><div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('gazeteler/save');?>" method="post">
                                <h4 style="font-size: 1.60rem;" class="display-4"><i class="mdi mdi-fire icon-md text-success"></i> Gazete Ayarları</h4><br />
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control" name="gazete_adi" placeholder="Gazete Adı Giriniz" required>
                                        </div>
                                        ...
                                        <select id="gazete_kategori" name="gazete_kategori" class="form-control form-control-sm">
                                            <option value="ulusal_gazeteler">Ulusal Gazeteler</option>
                                            <option value="spor_gazeteleri">Spor Gazeteleri</option>
                                            <option value="yerel_gazeteler">Yerel Gazeteler</option>
                                            <option value="yabanci_gazeteler">Yabancı Gazeteler</option>
                                            <option value="ekonomi_gazeteleri">Ekonomi Gazeteleri</option>
                                            <option value="sosyal_siteler">Sosyal Siteler</option>
                                            <option value="standart_web_siteler">Standart Web Siteler</option>
                                            <option value="televizyon">Televizyon</option>
                                            <option value="radyo">Radyo</option>
                                            <option value="dergiler">Dergiler</option>
                                            <option value="sponsor_medya" style="color:#ffc168; background-color: #13183E;">Sponsor Medya</option>
                                        </select>
                                        </div>
                                        ...
                                        <select id="gazete_sehir" name="gazete_sehir" class="form-control form-control-sm">
                                            <option value="sehir_none">--Şehir Seçiniz--</option>
                                            <?php foreach($items as $item){?>
                                                <option value="<?php echo seo($item->sehir_adi);?>"><?php echo $item->sehir_adi;?></option>
                                            <?php }?>
                                        </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control" name="gazete_url" placeholder="https://gazeteurladresi.com" required>
                                        </div>
                                        ...
                                        <select id="gazete_ukle" name="gazete_ukle" class="form-control form-control-sm">
                                            ...
                                            <option selected value="TUR">Türkiye</option>
                                    ...
                                    <button type="submit" value="submit" class="btn btn-primary mr-2">Gazete Ekle</button>
