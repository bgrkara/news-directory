                ...
                <div class="col-md-10"><div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('sehirler/save');?>" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="sehir_adi" placeholder="Şehir Adı Giriniz" required>
                                    </div>
                                    <!--Editör Alanı-->
                                    <div class="form-group">
                                    <h4 class="card-title">Şehir Hakkında Bilgi</h4>
                                    <textarea name="sehir_aciklama" id="simpleMde" class="form-control" placeholder="Şehir Hakkında Bilgi Giriniz."></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sehir_title" placeholder="Şehir SEO Başlığı Giriniz" maxlength="70">
                                        <small class="text-muted">Maksimum 70 Karakter ile Sınırlandırılmıştır.</small>
                                    </div>
                                    
                                    <div class="form-group">
                                        <h4 class="card-title">SEO Description Açıklama</h4>
                                        <textarea name="sehir_description" class="form-control" rows="2" placeholder="Şehir SEO Description Açıklama Giriniz" maxlength="170"></textarea>
                                        <small class="text-muted">Maksimum 170 Karakter ile Sınırlandırılmıştır.</small>
                                    </div>
                                    <div class="form-group">
                                        <h4 class="card-title">SEO Keywords</h4>
                                        <input type="text" class="form-control" name="sehir_keywords" placeholder="ankara gazeteleri,yerel gazeteler,gazete" value="gazeteler,gazete,yerel gazeteler, gazete dizini, gazete oku, tüm gazeteler, gazete bul, gazete listesi, ulusal gazeteler,">
