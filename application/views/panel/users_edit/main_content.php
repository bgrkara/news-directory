                ...
                <div class="col-md-10"><div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url("users/update/$row->id");?>" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control" pattern="[a-zA-Z0-9]+" name="user_name" value="<?php if (isset($row)) {
                                            echo $row->user_name;
                                        } ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="password" pattern="[a-zA-Z0-9]+" class="form-control" name="password" placeholder="******" disabled required>
                                    </div>
